...
export const initialTaskTemplates: TaskTemplate[] = [
    ...
    { id: 10, title: "Esvaziar a mente", description: "Use a técnica de 'Brain Dump'. Tire tudo da cabeça e ponha no app para reduzir a ansiedade.", category: "Pessoal", pomodoroEstimate: 1, energyNeeded: 'low', quadrant: 'schedule', timeOfDay: 'night' },
    ...
    { id: 22, title: "Corrida de Limpeza de 15 minutos", description: "Ative o modo turbo. O objetivo é progresso, não perfeição. Pare quando o tempo acabar. Vitória!", category: "Casa", pomodoroEstimate: 1, customDuration: 15, energyNeeded: 'medium', quadrant: 'do', timeOfDay: 'any' },
    ...
    { 
        ...
        timeOfDay: 'any',
        subtasks: [
            { text: "Organizar: Separar toda a louça por tipo (pratos, copos, etc.)" },
            { text: "Lavar: Pratos e copos" },
            { text: "Lavar: Talheres" },
            { text: "Lavar: Potes e panelas" },
            { text: "Finalizar: Secar e guardar a louça limpa" }
        ]
    },
    ...
    { id: 33, title: "Iniciar sessão Pomodoro de 25 minutos", description: "Mergulhe na tarefa com foco total. Apenas por 25 minutos. Você consegue.", category: "Estudos", pomodoroEstimate: 1, energyNeeded: 'high', quadrant: 'do', timeOfDay: 'any' },
    ...
    { 
        ...
        timeOfDay: 'morning',
        subtasks: [
            { text: "Esvaziar a mente: Listar pensamentos no app" },
            { text: "Revisar a agenda de hoje" },
            { text: "Escolher e marcar UMA tarefa como o \"Sapo do Dia\" 🐸" }
        ]
    }
];
