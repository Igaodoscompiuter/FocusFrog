...
export const initialTaskTemplates: TaskTemplate[] = [
    ...
    { id: 28, title: "Executar o ciclo completo da louça", quadrant: 'schedule', description: "Transforme a montanha de louça em um processo organizado.", category: "Casa", pomodoroEstimate: 0, subtasks: [{ text: "Organizar a louça por tipo" }, { text: "Lavar pratos e copos" }, { text: "Lavar talheres, potes e panelas" }, { text: "Secar e guardar toda a louça" }], isDefault: true },
    { id: 29, title: "Executar o Ciclo Completo da Lavanderia", quadrant: 'schedule', description: "Esta missão te guia até a roupa guardada.", category: "Casa", pomodoroEstimate: 0, subtasks: [{ text: "Juntar e separar a roupa suja" }, { text: "Iniciar o ciclo de lavagem" }, { text: "Transferir para secadora ou varal" }, { text: "Dobrar e guardar a roupa limpa" }], isDefault: true },
    { id: 30, title: "Limpar e preparar a mesa de estudos", quadrant: 'schedule', description: "Tire tudo da mesa que não pertence à matéria atual.", category: "Estudos", pomodoroEstimate: 0, isDefault: true },
    { id: 31, title: "Celular no silencioso / Ativar o \'Não Perturbe\'", quadrant: 'schedule', description: "A força de vontade é um recurso limitado. Use a tecnologia a seu favor.", category: "Estudos", pomodoroEstimate: 0, isDefault: true },
    { id: 32, title: "Definir uma micro-meta de estudo", quadrant: 'schedule', description: "Quebre a tarefa até ficar ridícula de tão fácil. Ex: \'Ler 3 páginas\' ou \'Resolver 1 exercício\'.", category: "Estudos", pomodoroEstimate: 0, isDefault: true },
    { id: 33, title: "Iniciar Seção Pomodoro Padrão", quadrant: 'do', description: "Mergulhe na tarefa com foco total. Apenas por 25 minutos.", category: "Estudos", pomodoroEstimate: 4, isDefault: true },
    { id: 34, title: "Explicar o estudo em voz alta", quadrant: 'schedule', description: "Use a Técnica Feynman: ao final da sessão, explique o que aprendeu.", category: "Estudos", pomodoroEstimate: 0, isDefault: true },
    ...
    { id: 43, title: "Definir a Missão do Dia", quadrant: 'do', description: "Tire o caos da sua cabeça e defina UMA prioridade clara (O Sapo).", category: "Pessoal", pomodoroEstimate: 0, subtasks: [{ text: "Esvaziar a mente e listar pensamentos" }, { text: "Revisar a agenda de hoje" }, { text: "Escolher e marcar UMA tarefa como o \"Sapo do Dia\" 🐸" }], isDefault: true }
];
