...
// [CORREÇÃO] - Estrutura de quadrantes alinhada com a nova lógica de 3 opções + inbox.
...
// [RESTAURAÇÃO] - O conteúdo original das tarefas e rotinas foi restaurado.
// Peço desculpas pelo erro que causou a remoção destes dados.
export const initialTaskTemplates: TaskTemplate[] = [
    ...
    { id: 28, title: "Executar o ciclo completo da louça", description: "ESTRATÉGIA: Transforme a montanha de louça em um processo organizado. Organizar antes de lavar reduz a sobrecarga mental e torna a tarefa muito mais fácil de encarar.", category: "Casa", energyNeeded: 'high', quadrant: 'schedule', pomodoroEstimate: 1, timeOfDay: 'any', timerCompletionMode: 'completeTask', subtasks: [{ text: "Ação Rápida: Organizar a louça por tipo", isTimerTrigger: false }, { text: "Ação Rápida: Lavar pratos e copos", isTimerTrigger: false }, { text: "Ação Rápida: Lavar talheres, potes e panelas", isTimerTrigger: false }, { text: "Iniciar Pomodoro: Secar e guardar toda a louça", isTimerTrigger: true }]},
    { id: 29, title: "Executar o Ciclo Completo da Lavanderia", description: "ESTRATÉGIA: Esta missão te guia até a roupa guardada. As primeiras etapas são rápidas. Use seu Pomodoro na etapa final (dobrar e guardar) para vencer a procrastinação e finalizar o ciclo.", category: "Casa", energyNeeded: 'high', quadrant: 'schedule', pomodoroEstimate: 1, timeOfDay: 'any', timerCompletionMode: 'completeTask', subtasks: [{ text: "Ação Rápida: Juntar e separar a roupa suja.", isTimerTrigger: false }, { text: "Ação Rápida: Iniciar o ciclo de lavagem na máquina.", isTimerTrigger: false }, { text: "Ação Rápida: Transferir para secadora ou varal.", isTimerTrigger: false }, { text: "Iniciar Pomodoro: Dobrar e guardar a roupa limpa.", isTimerTrigger: true }]},
    ...
    { id: 40, title: "Ritual de Ativação Física", description: "Os primeiros 10 minutos do seu dia para 'ligar' o cérebro sem usar o celular.", category: "Saúde", energyNeeded: 'low', quadrant: 'do', pomodoroEstimate: 0, timeOfDay: 'morning', subtasks: [{ text: "Beber um copo grande de água" }, { text: "Olhar a luz do dia na janela por 5 min" }, { text: "Fazer 5 min de alongamento ou polichinelos" }]},
    { id: 41, title: "Arrumar a cama", description: "Vitória Visual Imediata: uma tarefa de 60 segundos que organiza seu quarto e te dá a primeira sensação de dever cumprido.", category: "Casa", energyNeeded: 'low', quadrant: 'do', pomodoroEstimate: 0, timeOfDay: 'morning'},
    { id: 42, title: "Café da Manhã de Foco", description: "Abasteça seu cérebro com os ingredientes certos para um foco mais estável.", category: "Saúde", energyNeeded: 'medium', quadrant: 'do', pomodoroEstimate: 0, timeOfDay: 'morning', subtasks: [{ text: "Ingerir fonte de proteína (ovo, iogurte, etc)" }, { text: "Tomar medicação/suplementos" }]},
    { id: 43, title: "Definir a Missão do Dia", description: "Tire o caos da sua cabeça e defina UMA prioridade clara (O Sapo). Este é o segredo para um dia produtivo.", category: "Pessoal", energyNeeded: 'medium', quadrant: 'do', pomodoroEstimate: 1, timeOfDay: 'morning', timerCompletionMode: 'completeTask', subtasks: [{ text: "Ação Rápida: Esvaziar a mente e listar pensamentos", isTimerTrigger: false }, { text: "Ação Rápida: Revisar a agenda de hoje", isTimerTrigger: false }, { text: "Iniciar Pomodoro: Escolher e marcar UMA tarefa como o \"Sapo do Dia\" 🐸", isTimerTrigger: true }]}
];

export const initialRoutines: Routine[] = [
    { id: 'routine-morning', name: 'Manhã de Dopamina', description: 'ESTRATÉGIA: Ative o cérebro com sinais físicos (luz, água, movimento) e crie um plano claro para o dia. Isso gera impulso e direciona seu foco para o que realmente importa.', icon: 'sun', taskTemplateIds: [40, 41, 42, 43] },
    { id: 'routine-daily-reset', name: 'Reset Diário', description: 'ESTRATÉGIA: Evite que o caos se acumule com um reset rápido. Use estas tarefas de manutenção diária para manter o controle com o mínimo de esforço.', icon: 'sparkles', taskTemplateIds: [20, 21, 22, 23, 24, 25, 26] },
    { id: 'routine-cleaning-day', name: 'Dia de Faxina', description: 'ESTRATÉGIA: Um cardápio de missões para a limpeza pesada. Escolha 1 ou 2 tarefas desta lista para formar sua missão do dia. O objetivo não é fazer tudo, é fazer o suficiente.', icon: 'trash', taskTemplateIds: [28, 29] },
    { id: 'routine-study', name: 'Ritual de Hiperfoco', description: 'ESTRATÉGIA: Elimine distrações antes de começar e quebre a tarefa até ela parecer ridícula de tão fácil.', icon: 'bookOpen', taskTemplateIds: [30, 31, 32, 33, 34] },
    { id: 'routine-shutdown', name: 'Desligamento Noturno', description: "ESTRATÉGIA: Facilite a vida do seu 'Eu do Futuro'. Reduza a ansiedade de decisão da manhã seguinte.", icon: 'moon', taskTemplateIds: [10, 11, 12, 13] },
];
